// Package ohttpv1 is own http client
package ohttpv1
...
// Get 执行 Get 请求
func Get(url string) (string, *Response, error) {
	return request("GET", url, nil)
}

// Post 执行 Post 请求
func Post(url string, params map[string]string) (string, *Response, error) {
	return request("POST", url, params)
}

func request(method string, url string, params map[string]string) (string, *Response, error) {
...
func NewRequest(method string, url string, params map[string]string) (*Request, error) {
